...
const Exhibition = () => {
  return (
    <div className="container exhibitionContainer">
        ...
        <div className=" whyExhibit">
          ...
          <ul className="list-group">
            <li className="list-group-item">
              Direct in-event interaction with audience for product development
              and market research
            </li>
            <li className="list-group-item">Increase business traffic</li>
            <li className="list-group-item">Boost social strategy to target</li>
            <li className="list-group-item">
